...
# Script to compare QuantLib C++ currency data with Mojo implementation (Asia).
...
CPP_SOURCE_FILE="quantfork/ql/currencies/test_cpp_asia_runner.cpp" # Path relative to /app
CPP_RUNNER_PATH="./test_cpp_asia_runner" # Runner executable in /app
MOJO_RUNNER_SOURCE="quantfork/ql/currencies/asia_runner.mojo" # Source path relative to /app
MOJO_RUNNER_PATH="./asia_mojo_runner"   # Runner executable in /app

# --- Compilation (Run from project root /app) ---

echo "Compiling C++ test runner (Asia)..."
...
echo "Compiling Mojo test runner (Asia)..."
...
# --- Test Cases --- 
# List of currency codes defined in asia.mojo
currency_codes_to_test=(
    "BDT" "CNY" "HKD" "IDR" "ILS" "INR" "IQD" "IRR" "JPY" 
    "KRW" "KWD" "KZT" "MYR" "NPR" "PKR" "SAR" "SGD" "THB" 
    "TWD" "VND" "QAR" "BHD" "OMR" "JOD" "AED" "PHP" "CNH" "LKR"
)

echo ""
echo "Running Currency Data Tests (Asia)..."
