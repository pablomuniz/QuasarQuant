...
# Script to compare QuantLib C++ currency data with Mojo implementation (Oceania).
...
CPP_SOURCE_FILE="quantfork/ql/currencies/test_cpp_oceania_runner.cpp" # Path relative to /app
CPP_RUNNER_PATH="./test_cpp_oceania_runner" # Runner executable in /app
MOJO_RUNNER_SOURCE="quantfork/ql/currencies/oceania_runner.mojo" # Source path relative to /app
MOJO_RUNNER_PATH="./oceania_mojo_runner"   # Runner executable in /app

# --- Compilation (Run from project root /app) ---

echo "Compiling C++ test runner (Oceania)..."
...
echo "Compiling Mojo test runner (Oceania)..."
...
# --- Test Cases --- 
# List of currency codes defined in oceania.mojo
currency_codes_to_test=(
    "AUD" "NZD"
)

echo ""
echo "Running Currency Data Tests (Oceania)..."
