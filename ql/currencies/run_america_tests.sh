...
# Script to compare QuantLib C++ currency data with Mojo implementation (America).
...
CPP_SOURCE_FILE="quantfork/ql/currencies/test_cpp_america_runner.cpp" # Path relative to /app
CPP_RUNNER_PATH="./test_cpp_america_runner" # Runner executable in /app
MOJO_RUNNER_SOURCE="quantfork/ql/currencies/america_runner.mojo" # Source path relative to /app
MOJO_RUNNER_PATH="./america_mojo_runner"   # Runner executable in /app

# --- Compilation (Run from project root /app) ---

echo "Compiling C++ test runner (America)..."
...
echo "Compiling Mojo test runner (America)..."
...
# --- Test Cases --- 
# List of currency codes defined in america.mojo
...
echo ""
echo "Running Currency Data Tests (America)..."
